...
<!--<button class="button button9">New</button>


<button class="button button10">Load</button>-->

<form  method = "post" action = "saveNotes.php" id = "saving">
<button class="button button11">Save</button>
<textarea rows="50" cols="108" name = 'note' form = "saving"><?php echo $_SESSION['userNote']; ?></textarea>
</form>
